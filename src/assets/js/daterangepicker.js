...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            if (typeof options.startDate === 'string' && options.startDate != '' && options.startDate != null && moment(options.startDate, this.format).isValid())
                this.startDate = moment(options.startDate, this.format);

            if (typeof options.endDate === 'string' && options.endDate != '' && options.endDate != null && moment(options.endDate, this.format).isValid())
                this.endDate = moment(options.endDate, this.format);

            if (typeof options.minDate === 'string' && options.minDate != '' && options.minDate != null && moment(options.minDate, this.format).isValid())
                this.minDate = moment(options.minDate, this.format);

            if (typeof options.maxDate === 'string' && options.maxDate != '' && options.maxDate != null && moment(options.maxDate, this.format).isValid())
                this.maxDate = moment(options.maxDate, this.format);

            if (typeof options.startDate === 'object' && options.startDate != null && moment(options.startDate, this.format).isValid())
                this.startDate = moment(options.startDate);

            if (typeof options.endDate === 'object' && options.endDate != null && moment(options.endDate, this.format).isValid())
                this.endDate = moment(options.endDate);

            if (typeof options.minDate === 'object' && options.minDate != null && moment(options.minDate, this.format).isValid())
                this.minDate = moment(options.minDate);

            if (typeof options.maxDate === 'object' && options.maxDate != null && moment(options.maxDate, this.format).isValid())
